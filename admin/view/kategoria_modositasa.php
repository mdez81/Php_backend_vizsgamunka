                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-icon right">
                                                                                ...
                                                                                $kat_id = $_GET['id'];
                                                                                $adatok = $kategoria->osszesKategoriaId($kat_id);
                                                                                ?>
                                                                                <form method="post" action="../model/kategoria_modositasa.php?id=<?php echo $kat_id; ?>">
                                                                                    <input id="uszerzo" name="uszerzo" type="text" placeholder="szerző neve" value="<?php echo $adatok['kategoria_neve']; ?>" class="form-control " />
