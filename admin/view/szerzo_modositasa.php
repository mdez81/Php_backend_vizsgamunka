                                            ...
                                            <div class="panel panel-green">
                                                ...
                                                <div class="panel-body pan">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-icon right">
                                                                                ...
                                                                                require '../classes/Szerzo.php';   
                                                                                     ...
                                                                                     $sz_id = $_GET['id'];
                                                                                    $adatok = $szerzo->osszesSzerzoId($sz_id);
                                                                                    ?>
                                                                                <form  action="../model/szerzo_modositasa.php?id=<?php echo $sz_id; ?>" method="post">
                                                                                   
                                                                                    <input type="text" name="szNev" id="szNev" value="<?php echo $adatok['szerzo_neve']; ?>" >
                                                                                    <button type="submit" class="btn btn-green" name="ujszerzo">Save</button>&nbsp;
                                                    ...
                                                    <div class="form-actions text-right pal">
                                                        ...
                                                        <a href="szerzok.php" class="btn btn-danger"  name="megsem">Cancel</a>
                                                    </div>
