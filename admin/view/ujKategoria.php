...
<html lang="en">
    ...
    <body>
                                            ...
                                            <div class="panel panel-green">
                                                ...
                                                <div class="panel-body pan">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-icon right">
                                                                                 ...
                                                                                 <?php
                                                                                $hibaUzenetKateg = "";
                                                                                require '../model/kategoria_hozzaadas.php';
                                                                                ?>
                                                                                <form method="post">
                                                                                    <input id="kategoria" name="kategoria" type="text" placeholder="kategória neve" class="form-control ">
                                                                                    <span class="text-danger"><?php echo $hibaUzenetKateg; ?></span>
                                                                                    <button type="submit" class="btn btn-green" name="ujkategoria">Save</button>&nbsp;
                                                                                </form>
                                                    ...
                                                    <div class="form-actions text-right pal">
                                                        ...
                                                        <a href="kategoria.php" class="btn btn-danger"  name="megsem">Cancel</a>
                                                    </div>
        ...
        <script type="text/javascript" src="../assets/vendor.b4b0165630c3cba86c74.js"></script>
        <script type="text/javascript" src="./app.a5e8deedc708df27bfde.js"></script>
    </body>
</html>