            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div>
                            <a href="ujSzerzo.php" class="btn btn-primary" data-hover="tooltip" data-original-title="New"><i class="fa fa-plus"></i>&nbsp; New Author</a>
                            <!--<button type="button" class="btn btn-primary" data-hover="tooltip" data-original-title="New"><i class="fa fa-plus"></i>&nbsp; New Author</button>-->
                        </div>
...
<script type="text/javascript" src="../assets/vendor.b4b0165630c3cba86c74.js">
</script><script type="text/javascript" src="../assets/app.a5e8deedc708df27bfde.js"></script>
</body>
